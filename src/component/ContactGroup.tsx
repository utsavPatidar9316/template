...
import { data } from "../constant/ContactGroupData";
import VisibilityIcon from "@mui/icons-material/Visibility";
import { useState } from "react";
import ConfirmationDialog from "./ConfirmationDialog";
import Tooltip from "@mui/material/Tooltip";
import ContactGrpForm from "./ContactGrpForm";
const ContactGroup = () => {
  ...
  return (
    <>
      <h1 className="text-2xl font-bold m-2 flex justify-between">
        <span className="ml-4">Contacts Group</span>
        <span
      ...
      <ContactGrpForm open={open} setOpen={setOpen} />
      <ConfirmationDialog
        open={dialogOpen}
